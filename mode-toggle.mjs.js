  ...
  <style>
    *, ::after, ::before {
    ...
    label::before {
      ...
      background-size: 30px 30px; /* Adjusted for 20x20 icon */
      background-repeat: no-repeat;
      height: var(--${NAME}-icon-size, 30px); /* Adjusted for 20px height */
      width: var(--${NAME}-icon-size, 30px); /* Adjusted for 20px width */
