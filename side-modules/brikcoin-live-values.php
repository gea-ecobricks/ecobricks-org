...
$result = $conn->query($sql);
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo '<p style="font-size: 0.9em; margin-top:10px;">Unlike other currencies brikcoins <a href="/brikcoins.php">(BRK / ß)</a> are valued in ecological value measured in kilograms of authenticated ecobrick sequestered plastic (<a href="sequestered.php">AES</a>).</p>
            <p><a class="module-btn" href="https://gobrik.com/offset.php" target="_blank">Buy Plastic Offsets</a></p>
            <p><a class="module-btn" href="https://gobrik.com/#market" target="_blank">Bid for Brikcoins</a></p>
