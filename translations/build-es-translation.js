...
const es_Page_Translations = {
    ...
    "001-splash-title": "Aplicaciones de Ecoladrillos",
    "002-splash-subtitle": "Construcción práctica y principiada",
    "003-splash-image-alt": '<img src="../svgs/building-methods.svg" style="width: 85%" alt="Hay muchas formas de construir con ecoladrillos">',
    "004-lead-page-paragraph": "Los ecoladrillos pueden construir muebles, jardines, parques de juegos, estructuras y más. ¡El único límite es nuestra imaginación!",
    "005-first-page-paragraph": 'Dicho esto, construir con ecoladrillos es una gran responsabilidad. Para asegurar que los ecoladrillos y el plástico que contienen estén seguros y protegidos, la Alianza Global de Ecoladrillos (GEA) ha desarrollado guías, estándares y principios de construcción. Siguiendo estas mejores prácticas, podemos estar seguros de que nuestras aplicaciones de ecoladrillos mantienen el plástico <a href="sequest.php">secuestrado</a> a corto y largo plazo.',
  ...
  "008-short-term-content": "Se pueden usar silicona o bandas de cámara de aire como métodos de sujeción a corto plazo, no permanentes, para crear aplicaciones de ecobricks que duren meses y hasta varios años.",
  "009-short-term-detail": "Dado que las aplicaciones a corto plazo generalmente no están cubiertas, suelen ser para uso interior, para evitar la fotodegradación UV de las botellas. Las aplicaciones a corto plazo son más fáciles de hacer para las personas y aceleran la difusión mandálica del ecobrickeo y los principios regenerativos que encarnan.",
  "010-long-term-header": "<b>Aplicaciones a Largo Plazo</b>",
  ...
  "033-opener-header-text": "4. Open Spaces",
  "034-openspace-img-alt": '<img src="../photos/openspace-960px.jpg" width="100%" alt="Eco-brick open spaces for use with eco brick modules of all kinds" loading="lazy">',
  "035-openspace-description": "Ecobrick Open Spaces are for community that have completed thousands of high quality ecobricks with consistent bottle sizes and brands. These ecobricks can then be combined into an assortment of Milstein and Dieleman modules to create a diverse set of several hundred modules.",
  "036-main2-description": "These modules can then be deployed for conferences, exhibitions, fairs, and other special events to create customized interactive spaces. These spaces can either be set up in advance or invite participants to interact, play, and create their own space.",
  "037-side2-img-alt": '<img src="../webp/openspace.webp" width="100%" loading="lazy" alt="Examples of an eco brick open space">',
  "038-main3-description": "Ecobrick communities that have amassed Open Space sets often rent out to events and venues to showcase ecobrick modular technology and regenerative principles.",
  "039-side3-img-alt": '<img src="../webp/openspace.webp" width="120px" loading="lazy" alt="Example eco brick open space">',
  "040-maintenance-header": "🟡 Maintenance",
  "041-maintenance-info": "Open space module sets should be cleaned once a year. Broken modules can be repaired with silicone.",
  "042-next-life-header": "🟢 Next Life",
  "043-next-life-info": "Well-used ecobrick modules will last 2-3 years. After this time, the silicone joints began to weaken and to fail. Ecobricks also begin to lose their lustre as the colors of the contained plastic begin to fade. This is a good opportunity to transition them to long-term building applications where they are fully protected with earth.",
  "044-caution-header": "🔴 Caution",
  "045-caution-info": "Open spaces should be indoor or in covered spaces only. The UV rays in sunlight will degrade and fade your ecobricks and weaken the bottle’s plastic.",
  "046-action-btn-openspace": '<a class="action-btn" href="/openspace">🚀 Ecobrick Open Spaces</a>',
  "047-openspace-info": "Check our page all about Ecobrick Open Spaces.",

  "048-opener-header-text": "5. Earth & Ecobrick Building",
  "049-eco-brik-green-spaces-img-alt": '<img src="https://www.ecobricks.org/wp-content/uploads/2017/05/green-space.jpg" width="100%" alt="eco brik green spaces" loading="lazy">',
  "050-earth-building-description": "Our number one choice for structural building! This method is strong, earthquake resilient, allows curved walls and designs, allows ecobricks to be recycled at the end of the construction, and relies only on 100% organic, locally-sourced materials that cost next to nothing.",
  "051-earth-building-advantages": "Earth building was used by our ancestors to build homes and structures that have endured for centuries. This general method is known by different names in different languages and continents– cob, adobe, wattle-and-daub, etc. By using local earth, straw and sand to make the mortar for the ecobricks we can build in ways that are resilient, strong, beautiful, and thermal-retentive.",
  "052-main2-earth-principles": "Earth building is in full resonance with our principles — it is simple and replicable, non-capital, non-petroleum, collaboration powered, cradle-to-cradle and potently regenerative. Earth building techniques are gender and age transcendent: involving men and women, young and old, and everyone in between in the building process.",
  "053-side2-earth-building-img-alt": '<img src="https://www.ecobricks.org/wp-content/uploads/2020/04/cricle-bench-and-mango-tree-simple.svg" width="100%" loading="lazy" alt="eco brik and earth building can make tree benches">',
  "054-main3-garden-spaces": "Earth and Ecobrick Building is ideal for constructing simple garden spaces – playgrounds and what we call ‘food forest play parks‘.",
  "055-side3-earth-bench-img-alt": '<img src="https://www.ecobricks.org/wp-content/uploads/2020/04/cricle-bench-and-mango-tree-simple.svg" width="120px" loading="lazy" alt="eco brik and earth building can make tree benches">',
  "056-ecobrick-wall-technique": "The Ecobrick and Earth Building techniques can then be extrapolated for wall and structure construction.",
