...
const es_Page_Translations = {
  ...
  "016-opener-header-text": "<h4>Almacenamiento de Ecoladrillos</h4><h5>Antes de construir con ecoladrillos, es esencial almacenarlos correctamente.</h5><br>",
  "017-storage-img-alt": '<img src="../photos/eco-brick-storage-1000px.jpg" width="100%" alt="Un ejemplo de un depósito de almacenamiento de ecoladrillos para preparar la construcción" loading="lazy">',
  "018-storage-instruction": "Antes de construir con ecoladrillos, es esencial almacenarlos correctamente. Idealmente, los ecoladrillos se almacenan fuera del suelo (en un piso o elevados sobre madera) y completamente protegidos del sol y los elementos. Los ecoladrillos se apilan mejor horizontalmente con su base apuntando hacia afuera. Esto te permite organizar tus ecoladrillos por color y marca, lo que luego facilita la planificación del proyecto y la construcción.",
  "019-storage-banner-img-alt": '<img src="../webp/storage-banner-990px.webp" width="100%" loading="lazy" alt="Un ejemplo de cómo almacenar ecoladrillos correctamente">',
  "020-learn-more-guide": "ℹ️ Aprende más sobre cómo hacer y almacenar ecoladrillos correctamente: <a href=\"how.php\">Guía de Ecoladrillado en 10 Pasos</a>",

  "021-opener-header-text": "<h4>1. Módulos Milstein</h4><h5>La aplicación de ecoladrillos más fácil, rápida y quizás más divertida, son los Módulos Milstein en lego horizontal.</h5><br>",
  "022-milstein-img-alt": "Entrenadores de la GEA sentados en una mesa con módulos Milstein de ecoladrillos hechos de plástico",
  "023-milstein-description": "La aplicación de ecoladrillos más fácil, rápida y quizás más divertida, son los Módulos Milstein (MMs). Son configuraciones de forma hexagonal y triangular de ecoladrillos que se utilizan para sentarse, pero pueden combinarse para formar superficies horizontales de uno o dos niveles. Las aplicaciones incluyen mesas, camas, escenarios, etc. ¡Todo lo que necesitas son 12 ecoladrillos para comenzar! Se puede usar sellador de silicona genérico o cámaras de aire de motocicleta para hacer MMs. Los Módulos Milstein de ecoladrillos luego pueden deslizarse en despliegue para clases, conciertos, reuniones y más para hacer superficies horizontales. Se pueden apilar uno encima del otro para agregar un nivel de altura vertical. Se pueden apilar y almacenar verticalmente para ahorrar espacio.",
  "024-milstein-building-img-alt": "construcción de módulo de ecoladrillo Milstein",
  "025-maintenance-header": "🟡 Mantenimiento",
  "026-maintenance-info": "Los módulos deben limpiarse una vez al año. Los módulos rotos pueden repararse con silicona.",
  "027-next-life-header": "🟢 Próxima Vida",
  "028-next-life-info": "Los Módulos Milstein de ecoladrillos bien utilizados durarán de 2 a 3 años. Después de este tiempo, las juntas de silicona comienzan a debilitarse y fallar. Los ecoladrillos también comienzan a perder su lustre ya que los colores del plástico contenido comienzan a desvanecerse. Esta es una buena oportunidad para hacer la transición a aplicaciones de construcción a largo plazo donde estén completamente protegidos con tierra.",
  "029-caution-header": "🔴 Precaución",
  "030-caution-info": "Solo para uso en interiores. Los rayos UV del sol degradarán y desvanecerán tus ecoladrillos y debilitarán el plástico de la botella.",
  "031-action-btn-modules": "🚀 Módulos Milstein de Ecoladrillos",
  "032-modules-info": "Consulta nuestra página sobre las diversas variaciones de módulos horizontales de ecoladrillos.",
