const fr_Page_Translations = {
  ...
  '091-story-module-image-alt': 'Une vue des verdoyantes hautes terres Igorot du nord de Luzon',
  '092-story-module-header': 'Notre Histoire',
  '093-story-module-text': "L'Alliance Globale d'Écobriques est née sur la terre du peuple indigène Igorot, et nos pratiques sont guidées par leur éthique écologique cyclocentrique.",
  '094-story-module-btn': 'Lire Notre Histoire',
  '095-block6-header': 'Fondateurs',
  '096-block6-subheader': "La GEA a été fondée par des leaders locaux du mouvement à travers le monde en 2013.",
  '097-block6-p1': "En 2013, les mouvements &ldquo;bottle bricks&rdquo;, &ldquo;eco-bricks&rdquo; et &ldquo;EcoBricks&rdquo; prenaient leur essor à travers le monde. Sur les réseaux sociaux, Jo Stodgel (États-Unis), Candice Mostert (Afrique du Sud), Russell Maier (Canada/Philippines), Irene Bakisan (Philippines) et Ian Domisse (Afrique du Sud) se sont connectés les uns aux autres. Ils ont décidé qu'il était important d'être cohérents dans la façon dont ils parlaient et enseignaient ce qui était essentiellement la même méthodologie de transformation du plastique. D'abord, ils se sont mis d'accord sur une terminologie unique et cohérente : le terme unique, non capitalisé et non trait d'union &lsquo;ecobrick&rsquo;. Ils ont déposé ce domaine même, et ont lancé la page Wikipedia officielle d'&lsquo;ecobrick&rsquo;. Ensuite, ils ont décidé qu'il était important d'avoir une organisation qui veille sur les directives de base et les meilleures pratiques dont ils apprenaient rapidement qu'elles étaient cruciales. De là est née l'Alliance Globale d'Écobriques, et le reste appartient à l'histoire.",
  '098-block6-p2': "Vous pouvez lire l'histoire complète de l'Alliance Globale d'Écobriques <a href=\"story.php\">ici</a>.",
  '099-block6-p3': "Voir également la <a href=\"https://en.wikipedia.org/wiki/Ecobricks\" target=\"_blank\" rel=\"noopener\">page Wikipedia des Ecobricks</a>.",
  '100-block7-header': 'Cercle Central',
  '101-block7-subheader': "L'Alliance Globale d'Écobriques est guidée par un groupe bénévole de Formateurs et Formateurs Maîtres de la GEA qui se sont engagés à gérer les opérations et les décisions importantes de l'organisation.",
  '102-block7-p1': "En septembre 2026, notre Cercle Central de la GEA est composé de :",
  '103-block7-list': '<ul><li>Aang Hudaya &ndash; Bogor, Indonésie (Formateur Maître GEA)</li><li>Alex Setiadji &ndash; Kediri, Indonésie (Formateur Maître)</li><li>Ani Himawati &ndash; Jogja, Indonésie (Formateur Maître GEA)</li><li>Fran O&rsquo;Flanagan &ndash; Swindon, Royaume-Uni (Formateur)</li><li>Russell Maier (Formateur Maître, Cofondateur)</li><li>Lucie Mann &ndash; Hythe, Royaume-Uni (Formatrice Maître)</li><li>Paula Apollonia &ndash; Allemagne (Formatrice)</li><li>Rere Bening &ndash; Java Est, Indonésie (Formateur Maître)</li></ul>',
};
