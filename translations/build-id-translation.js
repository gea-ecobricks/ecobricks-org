...
const id_Page_Translations = {
    ...
    "016-opener-header-text": "<h4>Penyimpanan Ecobrick</h4><h5>Sebelum Anda membangun dengan ecobrick, sangat penting untuk menyimpannya dengan benar.</h5><br>",
    "017-storage-img-alt": '<img src="../photos/eco-brick-storage-1000px.jpg" width="100%" alt="Contoh depot penyimpanan ecobrick untuk persiapan pembangunan" loading="lazy">',
    "018-storage-instruction": "Sebelum Anda membangun dengan ecobrick, sangat penting untuk menyimpannya dengan benar. Idealnya, ecobrick disimpan di luar tanah (di lantai atau dinaikkan di atas kayu) dan sepenuhnya terlindungi dari matahari dan elemen. Ecobrick paling baik disusun secara horizontal dengan bagian bawahnya menghadap ke luar. Ini memungkinkan Anda untuk mengorganisir ecobrick Anda berdasarkan warna dan merek – yang kemudian memudahkan perencanaan proyek dan pembuatan.",
    "019-storage-banner-img-alt": '<img src="../webp/storage-banner-990px.webp" width="100%" loading="lazy" alt="Contoh cara menyimpan ecobrick dengan benar">',
    "020-learn-more-guide": "ℹ️ Pelajari lebih lanjut cara membuat dan menyimpan ecobrick dengan benar: <a href=\"how.php\">Panduan Ecobricking 10 Langkah</a>",

    "021-opener-header-text": "<h4>1. Modul Milstein</h4><h5>Aplikasi ecobrick yang paling mudah, tercepat, dan mungkin paling menyenangkan, adalah Modul Milstein lego horizontal.</h5><br>",
    "022-milstein-img-alt": "Pelatih GEA duduk di meja dengan modul Milstein ecobrick yang terbuat dari plastik",
    "023-milstein-description": "Aplikasi ecobrick yang paling mudah, tercepat, dan mungkin paling menyenangkan, adalah Modul Milstein (MMs). Ini adalah konfigurasi berbentuk heksagon dan segitiga dari ecobrick yang digunakan untuk duduk, tetapi dapat digabungkan bersama untuk membentuk satu atau dua permukaan horizontal. Aplikasi termasuk meja, tempat tidur, panggung, dll. Yang Anda butuhkan hanyalah 12 ecobrick untuk memulai! Silikon umum atau ban dalam motor dapat digunakan untuk membuat MMs. Modul Milstein Ecobrick kemudian dapat digeser ke dalam pengerahan untuk kelas, konser, pertemuan, dan lainnya untuk membuat permukaan horizontal. Mereka dapat ditumpuk satu di atas yang lain untuk menambah satu tingkat ketinggian vertikal. Mereka dapat ditumpuk dan disimpan secara vertikal untuk menghemat ruang.",
    "024-milstein-building-img-alt": "pembangunan modul ecobrick Milstein",
    "025-maintenance-header": "🟡 Pemeliharaan",
    "026-maintenance-info": "Modul harus dibersihkan sekali setahun. Modul yang rusak dapat diperbaiki dengan silikon.",
    "027-next-life-header": "🟢 Kehidupan Selanjutnya",
    "028-next-life-info": "Modul Milstein ecobrick yang digunakan dengan baik akan bertahan 2-3 tahun. Setelah waktu ini, sambungan silikon mulai melemah dan gagal. Ecobrick juga mulai kehilangan kilauannya karena warna plastik yang terkandung mulai memudar. Ini adalah kesempatan yang baik untuk beralih ke aplikasi bangunan jangka panjang di mana mereka sepenuhnya dilindungi dengan tanah.",
    "029-caution-header": "🔴 Perhatian",
    "030-caution-info": "Hanya untuk penggunaan di dalam ruangan. Sinar UV dari matahari akan merusak dan memudarkan ecobrick Anda dan melemahkan plastik botolnya.",
    "031-action-btn-modules": "🚀 Modul Milstein Ecobrick",
    "032-modules-info": "Periksa halaman kami tentang berbagai variasi modul horizontal ecobrick.",
