...
const es_Page_Translations = {
    ...
    "005-first-page-paragraph": 'La Alianza Global de Ecobricks utiliza terminología que ha sido determinada colectivamente por el movimiento global de ecobricks y establecida en el <a href="https://en.wikipedia.org/wiki/Plastic_sequestration" target="_blank">artículo de Wikipedia sobre Ecobricks</a> a través de nuestro sitio y recursos.',
    "006-second-page-paragraph": "Alentamos el mismo uso de términos y ortografías por periodistas, investigadores y ecobrickers para agregar consistencia y momento a los movimientos de transición plástica locales y globales.",
    "007-third-page-paragraph": "A continuación, proporcionamos una visión general de los términos de ecobrick, malentendidos, nuestras licencias de Creative Commons y nuestras etiquetas de atribución requeridas para usar o nuestros textos, fotos y videos.",
    
    "008-terms-title": "Términos y Ortografías",
    "009-terms-subtitle": "La ortografía generalmente aceptada para los términos clave.",
    "010-ecobrick-definition": "<b>Ecoladrillo</b>",
    "011-ecobrick-spelling": '<b>"ecoladrillo"</b> — sin espacio, guion ni mayúsculas adicionales es la ortografía reconocida. Esta es la ortografía reconocida de la entrada y URL del ecoladrillo en Wikipedia: <a href="https://en.wikipedia.org/wiki/ecobricks" target="_blank">wikipedia.org/wiki/ecobricks.</a>',
    "012-ecobrick-history": "En el pasado, se han utilizado términos como \"ladrillo de botella\", \"eco ladrillo\" y \"eco-ladrillo\" para referirse a una botella PET rellena de plástico. En 2014, líderes de la transición plástica de todo el mundo se reunieron y acordaron que nuestro concepto merecía su propia palabra plenamente reconocida y normalizada. La página de Wikipedia del ecoladrillo se actualizó en consecuencia en 2016.",
    "013-ecobrick-note": 'NOTA: Otras tecnologías de fabricación de ladrillos toman prestado el término ecoladrillo utilizando una variedad de ortografías. Corporaciones como Nestlé han intentado apropiarse del \'ecoladrillo\' para sus programas de responsabilidad social empresarial relacionados con bloques de cemento. Sin embargo, la secuestración de plástico en una botella PET es la <a href="https://en.wikipedia.org/wiki/Ecobrick" target="_blank">desambiguación reconocida en Wikipedia para la ortografía sin guion.</a>',
    "014-plastic-sequestration-definition": "<b>Secuestro de Plástico</b>",
    "015-plastic-sequestration-goal": 'El objetivo de hacer ecoladrillos es la <a href="https://en.wikipedia.org/wiki/Plastic_sequestration">secuestración de plástico</a>. Este es el término oficial según definido y reconocido en Wikipedia.',
    "016-ecobricker-definition": "<b>Ecoladrillero</b>",
    "017-ecobricker-description": "Alguien que hace un ecoladrillo o que se ha comprometido a hacer ecoladrillos con todo su plástico",
    "018-ecobricking-definition": "<b>Haciendo ecoladrillos</b>",
    "019-ecobricking-description": "El acto de secuestrar plástico dentro de un ecoladrillo.",
    ...
    "037-photos-gallery-description": "We've assembled a <a href=\"/gallery-kit\">gallery of wide-ranging ecobrick related photos</a> that you can freely use under our CC-A-SA-4.0 license.",
      ...
      "048-try-it-yourself": "And... be sure to try it yourself!",
      "049-try-it-yourself-content": 'The best way to document ecobricks is to try it yourself. We encourage you to save your household plastic for a month, weight it then ecobrick it. Then save and weigh your plastic consumption the next month. Subtracting your second month of consumption from your first, will show your <a href="transition.php">plastic transition</a> progress. Now, that\'s a good story! 👍',
      "050-learn-how": 'Lean How Make An Ecobrick',
      "051-ecobrick-guide": 'See our 10 Step Ecobrick Making Guide',
      "052-ecobrick-image-alt": '<img src="../svgs/eb-blue.svg" width="100%" alt="how to make an eco brick" loading="lazy">'
