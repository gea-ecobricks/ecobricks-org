...
const fr_Page_Translations = {
  ...
  '002-splash-subtitle': 'Une methode non-capitale, simple et low-tech pour prendre soin de notre plastique.',
  ...
  '006-second-page-paragraph': 'Une fois que de nombreuses écobriques sont disponibles, elles peuvent être utilisées à court terme dans des <a href="/modules">unités modulaires</a>, des <a href="/dms">meubles lego</a> et des <a href="/openspace">espaces ouverts</a>. Plus tard, nos écobriques peuvent également être utilisées à long terme dans des <a href="earth.php">jardins et structures terrestres</a>. Dans leur fabrication et leur application, les écobriques incarnent des <a href="principles.php">principes régénératifs</a> et une <a href="/ayyew">vision ayyew</a> basée sur le suivi de <a href="plastic.php">l\'exemple de la Terre</a> de sécuriser le carbone libre pour verdir la biosphère.',
