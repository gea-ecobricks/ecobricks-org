...
<HEAD>
	...
	<link rel="preload" as="image" href="webp/vision-bottom2.webp">
...
<BODY id="full-page">
	...
	<div id="cloud-box">
            ...
            <div id="cloud-banner"><img src="webp/vision-bottom2.webp" width="100%"><!--</div>
        ...
        <div id="header-content-block">
            <div id="raised-text">
                    <h1>Welcome to Plastic Transition</h1>
            <h5>Circular, zero-carbon, regenerative plastic management.</h5></div>
        </div>

<!-- SLIDER CONTENT -->


<div id="content-sect0">
	<div id="under-sliders">
...
-->
	<!--	<div id="slider1">
		...
		<div id="slider1">
			<div id="slider-image"><img src="webp/faqs-question.webp"  width="100%" alt="Check out our FAQ of ecobricks questions and answers"></div>
			<div id="slider-textbox">
				<div id="slider-heading">New FAQ Page!</div>
				<div id="slider-body">
					We're excited to launch a fully revamped Ecobrick Frequently Asked Question page.  Got a question about ecobricks?  Most likely we have an answer! </div>
				<div id="slider-date">September 18th, 2021 | GEA News</div>
				<div id="slider-link">>> <a href="faqs.html">FAQs</a></div>
			</div>
		</div>

		<div id="slider2">

			<div id="slider-image"><img src="webp/ayyew.webp" alt="The ayyew ecological ethos of the Igorot indegenous people"></div>
			<div id="slider-textbox">
				<div id="slider-heading">Inspired by Igorot Ancestral Wisdom</div>
...
<!--
		...
		<div id="slider3">
			<div id="slider-image"><img src="webp/2020-regen-report.webp" alt="The GEA's 2020 Regen Report"></div>
			<div id="slider-textbox">
		...
		<div id="slider4">
			<div id="slider-image"><br><img src="svgs/aes.svg"  width="100%" height="85%" alt="Authenticated Ecobrick Sequestered Plastic"></div>
			<div id="slider-textbox">
...
<div id="content-sect0-curved-bottom"></div><img src="svgs/vision-bottom-bottom2.svg" width="100%"></div>
	...
	<div id="content-sect1">
	 	<div id="main-content">
			<div id="dolphin-graphic"><img src="svgs/dolphin-top-optimized.svg"width="100%" height="76%" alt="Dolphins and turtles are happy when plastic stays out of the environment" ></div>
...
<div id="content-sect2">
	<div id="main-content">
		<div class="lead-graphic"><img src="svgs/earth-service3.svg" width="100%" height="96%" alt="Plastic unites us.  Ecobricking is open to everyone"></div>
		<!--<div class="big-header">A Deep Solution</div>-->
        <div class="lead-paragraph">Join the Regenerative Movement</div>
		<div class="sub-text">
		<p>Ecobricking is way for anyone anywhere to take personal responsibility for their plastic.  Together we can keep it out of the biosphere and out of capital and carbon intensive industrial processing.   Ecobricking follows the Earth's example towares cycling and sequestration.  Based on indegenous wisdom, extensive evaluation and earthen ethics, ecobricking isn't just about packing plastic-- it's about petro-capital transition.</p></div>
...
<div id="content-sect3">
	<div id="main-content">
		<div class="lead-graphic"><img src="svgs/build-circular4.svg" width="100%" height="90%" alt="All sort of earthen and cob structtures can be built with ecobricks"></div>
		...
		<div class="sub-text"><p>Ecobricks are reusable building blocks intended for building green spaces.  Use them make modules, home furniture, food-forest gardens, play parks, and more.  Ecobricking applications are fundamentally circular, zero-carbon and regenerative.</p>
		</div> 
...
<div id="content-sect4">
	<div id="main-content">
		<div class="lead-graphic"><img src="webp/balancing-green.webp"  width="100%" height="100%" alt="Ecological accounting and the balance of grey and green impacts"></div>
		<div class="lead-graphic"><img src="svgs/aes-brk.svg" width="100%" height="40%" alt="Brikcoins are based on Authenticated Ecobrick Sequestered Plastic"></div><!--width="300px" height="254px"-->
		<div class="lead-paragraph"><br>Introducing AES Plastic Offsetting</div>
		<div class="sub-text"><p>We live in the plastic age-- no matter how much we minimize, plastic consumption is an inevitable part of our petro-capital age. That's where ecobricking comes in-- and offsetting!   Imagine if for every 1kg of plastic consumed you could support 2kg of removed from industry and from the biosphere.  There's no better way to accelerate the plastic transition we all long to see.</p></div>
		...
		<p>The Brikcoin manual blockchain enables the authentication, valuation and vitalization of ecobrikcing.<br><a href="https://gobrik.com/#offset" target="_blank" rel="noopener">Offset your household or company plastic generation with us.</p><br>
		<img src="svgs/3brikcoins.svg" width="30%" alt="Brikcoin manual blockchain">
	</div>
</div>
