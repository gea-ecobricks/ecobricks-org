...
//                    echo "<div class='message'>Main image:<br><img src='{$targetPath}' width='500px'></div>";
    ...
    echo "<script>
    document.getElementById('ecobrick-being-processed').innerHTML = '';
    var gallery = document.getElementById('ecobricks-processed-gallery');
    var img = document.createElement('img');
    img.src = '{$uniqueThumbnailPath}';
    img.alt = 'Processed Ecobrick Thumbnail';
    img.width = 150;
