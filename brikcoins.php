...
<!-- The flexible grid (content) -->
	<div class="row">
		...
		<p>Since ancient times, currencies and coins have been based on certain materials, such as gold or silver, that have a value in-and-of-itself. In a similar way, Brikcoins (BRK / ß) are based on ecological value: the securing plastic out of the biosphere and out of industry by manual human labour.</p>
		
		<p>The system that generates this currency is the Brikcoin manual blockchain.</p>
