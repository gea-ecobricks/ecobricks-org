...
<!-- The flexible grid (content) -->
	<div class="row">
		...
		<p>Much like ancient currencies that were based on gold or silver that had a value in-itself, the Brikcoin manual blockchain (BRK / ß) is based on ecological value.  In particular the value of securing plastic out of the biosphere and out of industry by manual human labour.</p>
			
		<p>The <a href="brikchain.php">public Brikcoin blockchain</a> of transactions is generated by a permissionless, proof-of-value process of authentication.  This 'brikchain' is maintained and developed by the <a href="about.php">Global Ecobrick Alliance as a not-for-profit Earth Enterprise</a>.  This enables the decentralized authentication of plastic sequestration by anyone anywhere around the world who is willing to work with their hands.</p>
		</div>
            ...
            <div class="reg-content-block" id="block1">
                ...
                <div class="row">
						<div class="main2">
						<p>The rapid spread of blockchain cryptocurrencies has revolutionized the way currency is exchanged and recorded. Although, crypto currencies are useful as they fulfil all of the characteristics of a practical currency or coin, unlike traditional silver or gold coin, they don't have a value in and of theselves.</p>
						
						<p>These coins establish their value through scarcity that is acheived through computational authentication.  However, the ever increasing amount of computer work and hardware required for these 'proof of work' or 'proof of stake' blockchains has resulted in higher and higher environmental costs-- from energy, to ewaste, to emissions.</p>

						<p>Unlike these blockchains that simply prove the consistency of a digital ledger, Brikcoins operate on the concept of 'proof-of-value'.  This means that process of authentication confirms both the consistency of the ledger and of the creation of the currencies underlying value.</p> 

						<p>This 'proof of value' process is done manually-- by humans doing evaluation work.</p>
