...
<!-- The flexible grid (content) -->
	<div class="row">
		...
		<div class="page-paragraph">
			...
			<p>More than just numbers in ledger, every Brikcoin correlates directly with plastic that has been secured from from polluting the biosphere-- and permanently removed from industries that pollute. In the same way that ancient gold and silver coins had a value in and of themselves, Brikcoins are based on the ecological value that they represent.</p>
			</p>
            ...
            <div class="reg-content-block" id="block1">
                ...
                <div class="row">
                		...
                		<p>Two billion years ago, the Earth's atmosphere was full of carbon dioxide.  The planet's climate was unstable and its surface barren.  However, steadily the atmosphere's CO2 was cycled into carbon-based life.  Over time, as plants and animals lived and died, they were buried one by the other.  As more and more carbon ended up in the ground, there was less and less CO2 in the atmosphere.  Steadily the climate stabilized and the Earth's biosphere greened.</p>
					...
					<div class="row2">
						...
						<p>As we know too well, when plastic is dumped, it degrades into dangerous micro-plastics.  When plastic is incinerated it returns to the atmosphere as CO2.  And when plastic that is processed by industry it causes factories to spin and churn, resulting in more emissions and more plastic products.</p>
						
						<p>In contrast, the process of securing our plastic out of these routes, is known as plastic sequestration.  Plastic sequestration is defined as a manual, net-zero, non-industrial process.  In order to be sequesterd, the resulting secured-plastic must meet certain criteria to ensure that it is in fact green.</p> 
					...
					<h5>ℹ️ Learn more about <a href="/plastic">the Primordial Story of Plastic.</a></h5>
