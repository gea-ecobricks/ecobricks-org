...
<!-- The flexible grid (content) -->
	<div class="row">
		...
		<div class="page-paragraph">
            ...
            <p>Blockchain innovations have enabled a revolution in digital currencies. However, the increasing computational work they require has resulted in higher and higher energy demands all without generating anything that can be touched— nor with any real world value.</p>


			<p>In contrast, Brikcoins (BRK / ß) are generated by human work and based on ecological value.</p>
			...
			<p>We call this a proof-of-value, manual blockchain</p>
            ...
            <div class="reg-content-block" id="block1">
                ...
                <div class="opener-header">
                    ...
                    <h5>In following the Earth's example of carbon care we can generate authentic ecological and utility value.</h5>   
                    <br>
                    </div>
            ...
            <div class="reg-content-block" id="block2">
                ...
                <div id="preclosed2">
					...
					<div class="row2">
						...
						<p>In this way, Brikcoins avoid another pitfall of other blockhain currencies.  Rather than favor those who currency to invest, as a non-capital, manual and community powered process, Brikcoins favors anyone anywhere willing to work with their hands to make a meaningful ecological contribution.</p>
						</div>
                ...
                <div id="preclosed4">
					...
					<div class="row">
						<div class="main2">
							...
							<p>The brikcoin blockchain is developed and maintained by the Global Ecobrick Alliance in pursuit of its mission and vision of plastic transition. As a not-for profit Earth Enterprise, the GEA is guided by a mandate of achieving net-green ecological impacts and redistributing excess revenue back to the global ecobrick movement.</p>
						</div>
