...
<!-- The flexible grid (content) -->
	<div class="row">
		...
		<div class="page-paragraph">
            ...
            <p>Blockchain innovations have enabled a revolution in digital currencies. However, the increasing computational work required to generate them has resulted in higher and higher energy demands— all without generating any underlying value.</p>


			<p>In contrast, Brikcoins (BRK / ß) are generated by human work and based on real world value.</p>
