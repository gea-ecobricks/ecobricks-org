...
<div class="reg-content-block" id="block2">
    ...
    <div id="preclosed2">
        <div class="row">
            <div class="main2">
		<div class="splashimg2-1"><img src="../svgs/serving-the-people.svg" style="width: 85%" loading ="lazy"></div>
...
<div class="reg-content-block" id="block3">
	...
	<div class="splashimg3-1"><img src="../webp/ecobrick-authentications-brikcoin.webp" style="width:85%" loading ="lazy"></div>
	    ...
	    <div class="side2"><img src="../webp/White-Paper-Icon.webp" style="width:65%" alt="Download our Brikcoin White Paper for a full description of the Brikcoin Manual Blockchain." loading ="lazy">
		<p data-lang-id="016c-block-3-main-p1" style="font-size:0.9em !important"> Download our Brikcoin White Paper for a full description of the Brikcoin Manual Blockchain.</p></div>
        </div>
	<div class="row2">
