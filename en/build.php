        ...
        <div class="main">
         ...
         <!-- SHORT MEDIUM LONG  -->
            ...
            <div class="reg-content-block" id="block1">
                ...
                <a href="../pdfs/Plastic-Mellenium-Paths.pdf" target="_blank" data-lang-id="014-millenium-img-alt"><img src="../webp/mellenium-paths-400px.webp?v1.0" width="100%" alt="An example of an eco brick storage depot to prepare for building" loading="lazy" data-lang-id="014-image-mellenium-paths"></a>

                <p style="font-size: 0.85em; margin-top:20px;" data-lang-id="015-link to-chart">View a <a href="../pdfs/Plastic-Mellenium-Paths.pdf" target="_blank">chart of the various paths plastic can take</a> over 1000 years.</p>
</div>
</div>
