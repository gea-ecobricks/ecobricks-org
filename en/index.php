...
<?php require_once ("../includes/index-inc.php");?>
    ...
    <div class="feature-content-anchor-box">
        ...
        <div id="featured-slider">
            ...
            <div class="slider-dots" role="tablist" aria-label="Featured content navigation"></div>
        </div><!--featured-slider-->
...
<div class="featured-content-gallery" style="overflow-x:clip;">
    ...
    <div class="feature-sub-text">
        We've got a collection of great regenerative newsletters on Earthen for you to select from. Join <span class="earthen-subscriber-pill">69,0231</span> other planet passionate subscribers.
    </div>
