		...
		<div class="main">
			...
			<div class="reg-content-block" id="block1">
				...
				<div id="preclosed1">
					...
					<p>What we do with our plastic, as it adds or decreases the momentum of the petro-capital economy, has imminent ecological consequence.  Even though our personal choices may seem small, we observe that over time as our choices reverberate with others, they gather a momentum over that time that has enormous ecological consequences. In this way, ‘leading by personal example’ is one of our <a href="/principles">core principles</a>.</p>
			...
			<div class="reg-content-block" id="block2">
				...
				<div id="preclosed2">
                        ...
                        <div class="row2">
                            <div class="main3">
                            <p>As an Earth enterprise our focus is on generating authentic ecological value. </p>
                            </div>
			...
			<div class="reg-content-block" id="block3">
				...
				<div id="preclosed3">
					...
					<p>We make our resources, guides, and code open under the <a href="https://creativecommons.org/licenses/by-sa/4.0/">Creative Commons Attribution-ShareAlike 4.0 International Licenses</a>.
					</p><br>
			...
			<div class="reg-content-block" id="block4">
				...
				<div id="preclosed4">
					...
					<p>We maintain best practices and standards for<a href="what.php">the making of ecobricks</a> and the <a href="build.php">building applications</a> of them.</p><br>
					...
					<p>The GEA dialogues with the scientists, academics and indigenous leaders to support their work researching plastic pollution and developing plastic transition solutions.</a>.</p><br>
				</div>
			</div>
