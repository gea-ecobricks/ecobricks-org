	...
	<div class="row">
		<div class="main">
			...
			<div class="page-paragraph">
				...
				<p>Note that as of March 2022, this page and our listing here are still in development with the aim of formalizing our coefficients for the end of the year.</p>
			...
			<div class="reg-content-block" id="block2">
				...
				<p><b>Recycling</b></p>
					...
					<span title="GEA 2021 value"><h5>1 BRK = 0.098 Kg plastic</h5></span>
