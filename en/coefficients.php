...
<div id="main-content">
    ...
    <div class="row">
        <div class="main">
			...
			<h4 data-lang-id="014-take-out-coffee-label"><b>Take-out Coffee</b></h4>
			...
			<p title="GEA Estimate, 2020" data-lang-id="016-take-out-coffee-estimate" style="font-size: 1.2; font-weight:500;font-family:'Mulish',sans-serif;">0.01 Kg plastic</p><br>
			...
			<h5 title="GEA Estimate, 2020" data-lang-id="019-take-out-meal-estimate"><h5>0.125 Kg per meal</h5><br>
			...
			<h5 title="GEA Estimate" data-lang-id="022-domestic-air-travel-estimate">0.550 kg per ticket</h5><br>
			...
			<h5 title="GEA Estimate" data-lang-id="025-international-air-travel-estimate"><h5>0.750 kg per ticket</h5><br>
			<br><br><hr>
			...
			<h5 title="GEA Estimate" data-lang-id="030-propane-gas-estimate">0.001 Kg of plastic per cannister</h5><br>
			...
			<h5 title="Examining the Carbon Footprint of Devices, Microsoft, Sustainable Software, 2020" data-lang-id="033-laptop-estimate">0.5 Kg over lifetime of use</h5><br>
			...
			<h5 title="Examining the Carbon Footprint of Devices, Microsoft, Sustainable Software, 2020" data-lang-id="036-smart-phone-estimate">0.4 Kg over lifetime of use</h5><br>
		</div>
	</div>
</section>
