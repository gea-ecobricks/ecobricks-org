 ...
 <div id="header">
    ...
    <a href="index.html"><img src="logos/gea-horizontal.svg" alt="Global Ecobrick Alliance Logo" width="308" height="50"></a>
</div>
    ...
    <div class="topnav-lang" id="myTopnav-lang">
        <div class="dropdown-lang">
            ...
            <div class="dropdown-content-language">
                <a href='javascript:Localize.setLanguage("ed")'>🇬🇧 ENG</a>
