...
<!-- The flexible grid (content) -->
	<div class="row">
		...
		<p>Berdasarkan nilai ekologis dunia nyata, blockchain Brikcoin menyediakan jalan menuju transisi petro-modal.</p>
		</div>

		<div class="page-paragraph">

            <p>Inovasi Blockchain telah memungkinkan revolusi dalam mata uang digital. Namun, peningkatan pekerjaan komputasi yang diperlukan untuk menghasilkannya telah menghasilkan permintaan energi yang lebih tinggi dan lebih tinggi— semua tanpa menghasilkan nilai yang mendasarinya.</p>


			<p>Sebaliknya, Brikcoin (BRK / ) dihasilkan oleh pekerjaan manusia dan berdasarkan nilai dunia nyata.</p>

			<p>Lebih dari sekadar angka dalam buku besar, setiap Brikcoin berkorelasi langsung dengan plastik yang telah diamankan dari pencemaran biosfer— dan dihapus secara permanen dari industri yang mencemari. Dengan cara yang sama seperti koin emas dan perak kuno memiliki nilai tersendiri, Brikcoin didasarkan pada nilai ekologis yang diwakilinya.</p>

			<p>Kami menyebutnya sebagai bukti nilai, blockchain manual.</p>
		...
		<a name="ECO-VALUE"></a>
            <div class="reg-content-block" id="block1">
                ...
                <div class="opener-header">
					...
					<h4>Nilai Ekologis</h4>
                     <h5>Dengan mengikuti contoh Bumi tentang konsentrasi karbon, kami dapat menghasilkan nilai ekologis dan utilitas yang otentik.</h5>  
                    <br>
                    </div>
                ...
                <div class="row">
					...
					<p>Plastik yang dibuang akan terurai menjadi plastik mikro yang berbahaya. Ketika plastik dibakar, ia kembali ke atmosfer sebagai CO2. Dan saat plastik diproses oleh industri, hal itu menyebabkan pabrik berputar dan berputar, menghasilkan lebih banyak emisi dan lebih banyak produk plastik.</p>

<p>Namun, dengan mengikuti contoh Bumi dalam mengamankan, memusatkan, dan menyita cabon kita, kita dapat menjauhkan plastik kita dari biosfer dan keluar dari industri. Karya ini memiliki nilai ekologis yang penting sejauh dapat menghindari polusi, menghilangkan manfaat, dan mendukung keanekaragaman hayati.</p>

<p>Proses <a href="sequest">penyerapan plastik</a> ini didefinisikan sebagai proses non-industri manual, net-zero, (lihat <a href="https://en.wikipedia. org/wiki/Plastic_sequestration" target="_blnak">laman wikipedia</a>). Agar dapat diasingkan, plastik aman yang dihasilkan harus memenuhi kriteria sekuestrasi plastik untuk memastikan bahwa plastik tersebut benar-benar hijau.</p>

<p>Salah satu cara sekuestrasi plastik yang paling universal dan mudah diakses adalah <a href="what.php">ecobricking</a>.</p>

<p>Plastik ecobrick, <i>jika telah diautentikasi telah memenuhi kriteria sekuestrasi plastik</i>, mengandung nilai ekologi dan kegunaan. Nilai ini dapat diukur dengan berat plastik yang diasingkan di dalamnya.</p>

<p>Brikcoin didasarkan pada nilai ekologi <a href="/aes">plastik terasing ecobrick yang diautentikasi (plastik AES)</a>.</p>

<br><br>
<jam>
<h4>Pelajari Lebih Lanjut</h4><h4>
<h5>ℹ️ Artikel Wikipedia: <a href="https://en.wikipedia.org/wiki/Plastic_sequestration" target="_blank">Penyerapan Plastik.</a></h5>

<h5>ℹ️ <a href="sequest.php">Kriteria GEA untuk sekuestrasi plastik.</a></h5>

<h5>ℹ️ <a href="/plastic">Kisah Panjang Plastik.</a></h5>

<h5>ℹ️ Lebih lanjut tentang: <a href="/aes">Plastik AES.</a></h5>

<h5>ℹ️ Teori <a href="https://book.earthen.io" target="_blank">Etika Bumi</a> dalam mengikuti contoh Bumi.</a></h5>
                </div>
            </div>
