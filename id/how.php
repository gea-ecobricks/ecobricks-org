...
<div class="splash-content-block">
	<div class="splash-box">
		<div class="splash-heading" data-lang-id="001-splash-title">Cara Membuat Ecobrick</div>
	    <div class="splash-sub" data-lang-id="002-splash-subtitle">Panduan 10 Langkah dari GEA
Cara membuat ecobrick</div>
	</div>
	<div class="splash-image" data-lang-id="003-splash-image-alt"><img src="../webp/eb-sky-400px.webp" style="width: 85%" alt="Cara Membuat Ecobrick">
    </div>	
</div>
    	...
    	<div class="reg-content-block" id="block2">
			...
			<section id="INSCRIBE">
				<div class="reg-content-block" id="block9">
					<div class="opener-header">
						<div class="opener-header-text">
							<h4 data-lang-id="080">9. Inscribe</h4>
							<h5 data-lang-id="081">As you log and record your ecobrick, be sure to record the key data on the ecobrick itself too.</h5>   
						</div>
					...
					<div id="preclosed9">
						...
						<ul data-lang-id="084">
							...
							<li>Avoid using permanent markers. Not only does their writing not last long on PET, they are made of non-recyclable and non-ecobrickable materials.</li>
			...
			<section id="STORE">
				<div class="reg-content-block" id="block10">
					<div class="opener-header">
						<div class="opener-header-text">
							<h4 data-lang-id="088">10. Store your ecobrick</h4>
							<h5 data-lang-id="089">Once complete, you will need to store your ecobricks until you have enough for your project.</h5>   
						</div>
			...
			<section id="CONCLUSION">
				<div class="page-paragraph-reg">
					...
					<div class="row">
						<div class="main2">      
							<h4 data-lang-id="092">And Build!</h4>
							<p data-lang-id="093">Once you have enough Ecobricks you’re ready to build. There are five main techniques for building with bottles and ecobricks. The easiest, fastest, and perhaps the most fun Ecobrick application, is to make Milstein modules for horizontal building and Dieleman Lego modules for vertical building.</p>
						</div>

						<div class="side2">
							<br><img src="../webp/build-blue-450px.webp" width="150" loading="lazy" alt="eco brick building methods." data-lang-id="094">
						</div>
					</div>
