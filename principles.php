...
<!-- The flexible grid (content) -->
	<div class="row">
		...
		<p>Up until only a hundred years ago, currencies were based on value.  Much like ancient currencies were based on gold or silver that had a value in-itself, the Brikcoin manual blockchain (BRK / ß) is based on the ecological value of securing plastic out of the biosphere by human work. </p>
			
		<p>The <a href="brikchain.php">public brikchain</a> of transactions is generated by a permissionless, proof-of-value process that is maintained and developed by the <a href="about.php">Global Ecobrick Alliance as a not-for-profit Earth Enterprise</a>.  This enables the decentralized authentication of plastic sequestration by anyone anywhere around the world who is willing to work with their hands.</p>
		</div>
