...
<div class="splash-content-block">
    ...
    <div class="splash-box">
		<div class="splash-heading" data-lang-id="001-splash-title">Compensation du Plastique</div>
...
<!-- The flexible grid (content) -->
	<div class="row">
		<div class="main">
            ...
            <p data-lang-id="005-first-page-paragraph">And plastic offsetting is a place to start!</p>

				<p data-lang-id="006-second-page-paragraph">Offsetting is all about making sure our green impacts outweigh our grey. Just as keen green households and companies buy carbon offset credits, so too can they buy plastic offset credits.  Whereas carbon credits help balance off our emissions, plastic offsets can be purchased to balance our plastic consumption and production.  Paying for offset credits serves as strong financial incentive for buyers to reduce and eliminate their plastic use altogether.</p>
                    
                <p data-lang-id="007-third-page-paragraph">Meanwhile, payments go direct to energizing those working hard to sequester plastic and transition from it.</p>  
				...
				<div class="reg-content-block" id="block5">
					<div class="opener-header">   
						<div class="opener-header-text">
							<h4 data-lang-id="008-block-5-opener-header">Like Carbon Offsetting— but for plastic!</h4>
							<h5 data-lang-id="009-block-5-opener-subheader">If curbing CO2 emissions are an important part of being green― so too is curbing our plastic polluting.</h5>   
						</div>
			...
			<section id="GEA">
				<div class="reg-content-block" id="block6">
					<div class="opener-header">
						<div class="opener-header-text">
							<h4 data-lang-id="017-block-6-opener-header">The Role of the GEA</h4>
							<h5 data-lang-id="018-block-6-opener-subheader">The Global Ecobrick Alliance maintains the blockchain that underlies the plastic offsetting system.</h5>               
						</div>
...
<div class="reg-content-block" id="block1">
    <div class="opener-header">
        <div class="opener-header-text">
            <h4 data-lang-id="022-block-1-header">How is the price of offsets determined?</h4>
            <h5 data-lang-id="023-block-1-subheader">The price of 1kg of AES plastic is determined by the cost of its authentication</h5>
        </div>
    ...
    <div id="preclosed1">
                ...
                <p data-lang-id="024-block-1-paragraph">To calculate the price of 1kg of authenticated plastic, the Global Ecobrick Alliance divides its costs of operating and maitaining the blockchain by the amount of plastic that has been authenticated.</p>

                <p data-lang-id="025-block-1-paragraph">For example: In 2023 the Global Ecobrick Alliance incurred 7,207.14 $ USD of expenses in order to authenticate 2,228.96 Kg AES of ecobricked plastic. That works out a cost of 3.23 $ USD per Kg in maintaining the block chain and authentication system. This sets our valuation of the price per Kg of AES plastic offsets for the subsequent year (2024).</p>
                <br>
                <h5 data-lang-id="026-block-1-info-1">ℹ️ View our <a href="open-books.php">GEA Open Books</a></h5>
                <h5 data-lang-id="027-block-1-info-2">ℹ️ Learn more about <a href="sequest.php">Plastic Sequestration</a></h5>
    </div>  
</div>
...
<div class="reg-content-block" id="block2">
    ...
    <div id="preclosed2">
        ...
        <p data-lang-id="037-block-2-paragraph">Most importantly, the cash value of plastic offset credits goes direct to the Global Ecobrick Alliance which uses the funds to maintain Ecobricks.org, the GoBrik app and Brikcoin blockchain.  These sites and apps serve ecobrickers around the world. </p>
        
        <p data-lang-id="038-block-2-paragraph">The GEA is structured as a not-for-profit, Earth enterprise precisely so that it can fulfill this purpose and maintain these systems to serve and benefit ecobrickers locally and globally.  All the GEA's expenses and revenues are declared on our <a href="open-books.php">open books system</a> so that not only do we operate with full transparency, but also, so that the annual price of 1kg of AES plastic can be set with full transparency.</p>
<br>
        <h5 data-lang-id="039-block-2-info-1">ℹ️  Learn more about: <a href="brikchain.php">Brikchain Manual Blockchain</a></h5>

        <h5 data-lang-id="040-block-2-info-2">ℹ️  Learn more about: <a href="about.php">The Global Ecobrick Alliance</a></h5>
...
<div class="reg-content-block" id="block3">
    <div class="opener-header">
        <div class="opener-header-text">
            ...
            <h5 data-lang-id="042-block-3-subheader">Offsetting is can be a key component of green living and green enterprise</h5>
        </div>
    ...
    <div id="preclosed3">
        ...
        <div class="row">
            <div class="main2">
                ...
                <p data-lang-id="045-block-3-main-p2">When plastic offsets are purchased, the Global Ecobrick Alliance issues a serialized certificate of the net weight in kilograms of the purchase.  Both the currency transaction and the offsetting credits are recorded in our open books accounting system and our brikcoin blockchain.<p>

                <p data-lang-id="046-block-3-main-p3">The certificate and transaction links are ideal to be used as references in your regenerative or sustainability accounting.  You can use your purchased plastic credits to balance off either your plastic consumption or production.  You can use the CO2 equivalency of your purchased offset credits to balance your CO2 emissions.</p>
            </div>
            <div class="side2" data-lang-id="047-block-3-img1-alt">
                <img src="../webp/aes-offset-certificate-400px.webp" width="300" style="width:100%;" alt="AES plastic offset certificate" loading="lazy" >
            </div>
        </div>
        <br>
        <h5 data-lang-id="048-block-3-info-1">ℹ️ Learn more about: <a href="/aes">Authenticated Ecobrick Sequestered Plastic</a></h5>
...
<div class="reg-content-block" id="block4">
    <div class="opener-header">
        <div class="opener-header-text">
            <h4 data-lang-id="049-block-4-header">White Paper & Resources</h4>
            <h5 data-lang-id="050-block-4-subheader">Learn more about the manual blockchain powering our plastic offsetting.</h5>
        </div>
    ...
    <div class="row">
					...
					<div class="row2">
						...
						<div class="main3">
							<p data-lang-id="053-block-4-download">📥 Download: <a href="https://nextcloud.ecobricks.org/index.php/s/fNNYjG7A3gxco9n" target="_blank">The Commodification of Sequestered Plastic</a></p><h5>📄 GEA White Paper | PDF | 2.1 MB</h5>
						</div>

						<div class="side3" data-lang-id="054-block-4-img-alt">
					...
					<p style="font-size: small;" data-lang-id="055-block-4-last-paragraph">The Brikcoin blockchain has been operating since 2019 and has overseen the authentication of hundreds of tons of plastic and tens of thousands of dollars of plastic offsetting.</p>
