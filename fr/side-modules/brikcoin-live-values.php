...
$result = $conn->query($sql);
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<img src="../svgs/aes-brk-vertical.svg?v=3" style="width:95%; margin-top:20px;"><p style="font-size: 1.0em; margin-top:5px;">Valeur actuelle du Brikcoin en direct :</p>
