            ...
            <div class="row">
                <div class="main">
                    ...
                    <div class="page-paragraph">
                         ...
                         <div class="virtue-icons" data-lang-id="007-virtue-icons"><img src="../pngs/earthwand-virtue-icons.png" style="width:100%;" alt="Earthwand design principles"></div>
                        ...
                        <div class="earthwand-gallery" style="width:100%, display:flex; flex-flow:column">
                            <div class="earthwand-photo-duo" style="width:100%, display:flex; flex-flow:row; padding:15px;">
                                <div class="earth-photo">
                                    <img src="earthwand-photo-1-500px.webp" alt="Earthwands">
                                </div>
                                <div class="earth-photo">
                                    <img src="earthwand-photo-2-500px.webp" alt="Earthwands">
                                </div>
                            </div>
                            <div class="earthwand-photo-duo" style="width:100%, display:flex; flex-flow:row; padding:15px;">
                                <div class="earth-photo">
                                    <img src="earthwand-photo-3-500px.webp" alt="Earthwands">
                                </div>
                                <div class="earth-photo">
                                    <img src="earthwand-photo-4-500px.webp" alt="Earthwands">
                                </div>
                            </div>
                        </div>
