...
<?php
			...
			$result = $conn->query($sql);
					...
					while($row = $result->fetch_assoc()) {
						...
						<p><span class="courier" style="font-size: 1.5em;"><span class="blink">⬤<span style="font-size: 0.4em;"> </span></span>'.$row["plastic_value_kg_per_brk"].'<span style="font-size: 0.4em;"> </span>Kg<span style="font-size: 0.4em;"> </span>AES</span></p>' ; 
