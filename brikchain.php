...
<?php
			...
			$result = $conn->query($sql);
					...
					while($row = $result->fetch_assoc()) {
						...
						echo '<img src="svgs/aes-brk.svg?v=2" style="width=70%; magin-top:25px;"><p style="font-size: 1.2em; margin-top:5px;">Current value of 1 Brikcoin:</p><p><span class="blink" style="font-size: 1.5em;">◉ </span><span class="courier" style="font-size: 1.5em;">'.$row["plastic_value_kg_per_brk"].'Kg AES</span></p>' ; 
