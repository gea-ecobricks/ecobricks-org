		...
		<div class="main">
			...
			$result = $conn->query($sql);
					...
					while($row = $result->fetch_assoc()) {
						...
						echo '<p style="font-size: 0.8em; margin-top:20px;">Current value of 1 Brikcoin:</p><p><span class="blink">◉  '.$row["plastic_value_kg_per_brk"].'&#8202;Kg of AES plastic</span></p>' ; 
						echo '<p style="font-size: 0.8em; margin-top:20px;">Unlike other currencies <a href="/brikcoins.php">brikcoin (BRK / ß)</a> are measured in the ecological value of <a href="sequestered.php">plastic sequestered out of the industry & biosphere</a>.' ; 
