		...
		<div class="main">
			...
			$result = $conn->query($sql);
					...
					while($row = $result->fetch_assoc()) {
						...
						echo '<p><span class="blink">◉  </span>  '.$row["plastic_value_kg_per_brk"].'&#8202;Kg of AES plastic</p>' ; 
						echo '<p style="font-size: 0.8em; margin-top:20px;">Unlike other currencies Brikcoins are measured in the ecological value of <a href="sequestered.php">plastic sequestered out of the industry & biosphere</a>.' ; 
						echo '<p style="font-size: 0.8em; margin-top:20px;">Amount of <a href="/brikcoins.php">brikcoin</a> in circulation: '.$row["net_brk_in_circulation"].'&#8202;ß</p></div>' ; 
