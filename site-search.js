 ...
 function presentSearchResults(posts, query) {
    ...
    if (outputPosts.length == 0) {
       ...
       for (var k = 0; k < outputPosts.length; k++) {
          ...
          resultsContainer.innerHTML += "<div class=\"tc-item\"><div id='result_" + k + "' style=\"display:flex; text-align:left; padding: 20px;\"><div class=\"search_chapter_pic\" ><img src=\"" + imageUrl + "\"></div><div class=\"chapter-name-search\"><a href='" + currentPost.url + "'><div class=\"chapter-title-search\">" + currentPost.title + "</div><div class=\"description_search\">" + currentPost.description + "</div><span style=\"font-size:smaller;color:grey;margin-top:10px;display:block;\">" + currentPost.section + "  |  " + currentPost.language + " | ↳ ../" + currentPost.lang_key + "/" + currentPost.url + "</span></a></div>";
       }
    }
 }
