 ...
 function presentSearchResults(posts, query) {
    ...
    if (outputPosts.length == 0) {
       ...
       for (var k = 0; k < outputPosts.length; k++) {
          ...
          resultsContainer.innerHTML += "<div class=\"tc-item\"><div id='result_" + k + "' style=\"display:flex; text-align:left; padding: 20px;\"><div class=\"search_chapter_pic\" ><img src=\"" + imageUrl + "\"></div><div class=\"chapter-name-search\"><a href='" + currentPost.url + "'><div class=\"chapter-title-search\">" + currentPost.title + "</div><span style=\"font-size:small;color:var(--drop-cap)!important;margin-top:10px;display:block;\">" + currentPost.section + "  |  " + currentPost.language + "</span><span style=\"font-size:medium;font-family:'Mulish',sans-serif;margin-top:10px;display:block;\">" + currentPost.description + "</span><span style=\"font-size:smaller;color:grey;margin-top:10px;display:block;\">↳ ../" + currentPost.lang_key + "/" + currentPost.url + "</span></a></div>";
       }
    }
 }
