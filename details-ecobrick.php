...
if ($result->num_rows > 0) {
    ...
    while($array = $result->fetch_assoc()) {
		...
		echo " <p><b>Density:</b> <var>" . $array["density"] ."#8202;g/ml</var></p>" ;
		echo " <p><b>Dated:</b><var>" . $array["date_logged_ts"] ."</var></p>" ;
		...
		echo " <p><b>Authenticated weight:</b></p><var> " . $array["weight_authenticated_kg"] ."#8202;kg</var></p>" ;
		...
		echo " <p><b>Display value:</b> <var>" . $array["ecobrick_brk_display_value"] ."</var></p>" ;
		echo " <p><b>Brikcoin amount:</b> <var>" . $array["ecobrick_brk_amt"] ."&#8202;ß</var></p>" ;
		echo " <p><b>Brikcoin amount:</b> <var>" . $array["ecobrick_dec_brk_val"] ."&#8202;ß</var></p></br>" ;
