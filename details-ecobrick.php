...
if ($result->num_rows > 0) {
    ...
    while($array = $result->fetch_assoc()) {
		...
		echo '<div class=\"main-details\"><img src="'. $array["ecobrick_full_photo_url"] .'" width="500" alt=		<div id ="main-details">"Ecobrick basic pic"/>';
		echo "</br><div class=\"serial\">Serial: <var>" . $array["serial_no"] ."</var></div> </br>";
		...
		echo "  <div class=\"general-field\"><b>Region:</b> <var>" . $array["location_region"] ."</var></p>" ;
