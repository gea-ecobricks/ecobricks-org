...
if ($result->num_rows > 0) {
    ...
    while($array = $result->fetch_assoc()) {
		...
		echo "</br><div class=\"serial\">Ecobrick Serial No: <var>" . $array["serial_no"] ."</var></div> </br>";
		...
		echo " <div class=\"main\"><b>Brikcoin value:</b> <var>" . $array["ecobrick_dec_brk_val"] ."&#8202;ß</var></div></div></br>" ;
