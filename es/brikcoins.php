...
<div id="splash-content-block">
	<div id="splash-box">
		...
		<div class="splash-sub">Una cadena de bloques de prueba de valor manual basada en el secuestro de plástico de la biosfera.</div>
...
<!-- The flexible grid (content) -->
	<div class="row">
		...
		<p>Basada en el valor ecológico del mundo real, la cadena de bloques Brikcoin allana el camino para la transición del petro-capital.</p>
		</div>

		<div class="page-paragraph">

            <p>Las innovaciones de Blockchain han permitido una revolución en las monedas digitales. Sin embargo, el trabajo computacional cada vez mayor requerido para generarlos ha resultado en demandas de energía cada vez más altas, todo sin generar ningún valor subyacente.</p>


			<p>A diferencia de,, los Brikcoins (BRK / ß) son generados por el trabajo humano y se basan en el valor del mundo real.</p>

			<p>Más que números en una cadena, cada Brikcoin se correlaciona directamente con el plástico que se ha asegurado de no contaminar la biosfera y se ha eliminado permanentemente de las industrias que contaminan. De la misma manera que las antiguas monedas de oro y plata tenían valor por sí mismas, las Brikcoins se basan en el valor ecológico que representan.</p>

			<p>A esto lo llamamos blockchain manual de prueba de valor.</p>
            ...
            <div class="reg-content-block" id="block1">
                ...
                <div class="opener-header">
                    ...
                    <h4>Valor ecológico</h4>
                    <h5>Siguiendo el ejemplo de la Tierra en el cuidado del carbono podemos generar auténtico valor ecológico.</h5>   
                    <br>
                    </div>
                ...
                <div class="row">
					...
					<div class="row2">
						...
						<p>In this way securing our plastic out of these routes, has important ecological value.  Especially when we concentrate and secure plastic in the same way that the Earth cared for it carbon.</p>
                ...
                <div id="preclosed4">
					...
					<div class="row">
						<div class="main2">
							...
							<p>The Brikcoin blockchain is developed and maintained by the Global Ecobrick Alliance in pursuit of its mission and vision of plastic transition. As a not-for profit Earth Enterprise, the GEA is guided by a mandate of acheiving net-green ecological impacts and redistributing excess revenue back to the global ecobrick movement.</p>
						</div>
