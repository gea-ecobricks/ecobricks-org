...
<div class="splash-content-block">
	<div class="splash-box">
		<div class="splash-heading">Aplicaciones de Ecobricks</div>
	    <div class="splash-sub">Construcción Ecobrick práctica y con principios.</div>
	</div>
	...
	<div class="row">
		<div class="main">
			...
			<div class="lead-page-paragraph">
                <p>Los ladrillos ecológicos pueden construir muebles, jardines, parques infantiles, estructuras y más. ¡El único límite es nuestra imaginación!</p>
			</div>
			
			
			<div class="page-paragraph">
                <p>Dicho esto, construir con ecoladrillos es una gran responsabilidad. Para asegurarse de que los ecoladrillos y el plástico que contienen sean seguros y protegidos, Global Ecobrick Alliance (<a href="about.php">GEA</a>) ha desarrollado pautas, estándares y principios de construcción. Al seguir estas mejores prácticas, podemos estar seguros de que nuestras aplicaciones de ladrillos ecológicos mantienen el plástico <a href="sequest.php">secuestrado</a> a corto y largo plazo.</p>
