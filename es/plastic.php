...
<!--PAGE BANNER-->
 ...
 <div class="splash-content-block">
	<div class="splash-box">
		<div class="splash-heading" data-lang-id="001-splash-title">La Larga Historia del Plástico</div>
	    <div class="splash-sub" data-lang-id="002-splash-subtitle">Conocer el pasado primordial del plástico es la clave para asegurar su futuro verde hoy.</div>
	</div>
